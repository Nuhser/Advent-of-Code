...
class Solution(aoc.AbstractSolution):
    ...
    def part1(self) -> tuple[str, (int | str)]:
        ...
        return f"Total number of unnecessary sections: {doubled_sections}", doubled_sections
    ...
    def part2(self) -> tuple[str, (int | str)]:
        ...
        return f"Total number of unnecessary sections: {intersections}", intersections